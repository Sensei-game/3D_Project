...
namespace Labs.Lab4
{
    public class Lab4Window : GameWindow
    {
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            //L5T5 Added texture coordinates to vertices – mesh is broken
            ...
            string filepath = @"Lab4/Texture2.png";
 ...
 //L5T6 Fixed mesh it was 2 initially
            ...
            //L5T7 Can visualize texture coordinates
        ...
        protected void OnUpdateFrame(EventArgs e)
        {
            ...
            //L5T11 Made a very cool animated dissolving effect NOT YET
        }
        ...
        protected override void OnRenderFrame(FrameEventArgs e)
        {
            ...
            // GL.DrawElements(PrimitiveType.LineStrip, 48, DrawElementsType.UnsignedInt, 0);
            //L5T1 Changes primitive type from triangles to lines
            //L5T2 Changes primitive type from lines to triangles

           
            //L5T3 Loaded an image from the disk into memory
        ...
        protected override void OnUnload(EventArgs e)
        {
            ...
            mShader.Delete();
            base.OnUnload(e);
            //L5T12 Deleted the texture from the graphics card memory NOT YET
        }
    }
}
