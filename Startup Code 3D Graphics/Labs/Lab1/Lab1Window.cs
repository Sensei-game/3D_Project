...
namespace Labs.Lab1
{
    public class Lab1Window : GameWindow
    {
        ...
        {
            GL.ClearColor(Color4.Blue); //L1T1 Changed the clear colour and drew my first triangle!
            ...
            //Swaped vertices 3 & 4 since 1 & 2 are the SAME!
        ...
        protected override void OnRenderFrame(FrameEventArgs e)
        {
            ...
            //L1T4 This time only the second half of the square was drawn because… REASONS ^_^7
